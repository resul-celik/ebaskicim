...
?>
<p class="woocommerce-result-count paragraph-lg text-gray-600" role="alert" aria-relevant="all" <?php echo (empty($orderedby) || 1 === intval($total)) ? '' : 'data-is-sorted-by="true"'; ?>>
	<?php
