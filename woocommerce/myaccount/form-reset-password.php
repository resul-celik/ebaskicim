...
<form method="post" class="woocommerce-ResetPassword lost_reset_password jun-login-page input-field-wrapper">
	...
	<h2 class="login-title"><?php echo apply_filters('woocommerce_reset_password_message', esc_html__('Enter a new password below.', 'woocommerce')); ?></h2><?php // @codingStandardsIgnoreLine 
																																								?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last input-field">
	...
	<p class="woocommerce-form-row form-row input-field">
		...
		<button type="submit" class="woocommerce-Button button primary-button button-sm blue-button <?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>" value="<?php esc_attr_e('Save', 'woocommerce'); ?>"><?php esc_html_e('Save', 'woocommerce'); ?></button>
	</p>
