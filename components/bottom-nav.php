...
<nav class="bottom-nav md:hidden" aria-label="Alt Navigasyon">
    <div class="bottom-nav-inner">
        ...
        <a href="<?php echo esc_url(site_url()); ?>"
            ...
            aria-label="Anasayfa">
            <i class="<?php echo is_front_page() ? 'filled-icon' : 'icon'; ?> icon-home"></i>
        ...
        <?php if (!is_cart()) : ?>
            <button type="button" class="bottom-nav-item cart-button" aria-label="Sepetim">
                <span class="bottom-nav-icon-wrap">
                    ...
                    <?php endif; ?>
                    <i class="<?php echo is_cart() ? 'filled-icon' : 'icon'; ?> icon-cart"></i>
                </span>
        ...
        <a href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>"
            ...
            aria-label="Hesabım">
            <i class="<?php echo is_account_page() ? 'filled-icon' : 'icon'; ?> icon-person"></i>
...
?>
<div class="mobile-search-overlay<?php echo is_user_logged_in() ? ' pt-46 md:pt-52' : ''; ?>" id="mobile-search-overlay" hidden aria-modal="true" role="dialog">
