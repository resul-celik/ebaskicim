...
?>
    ...
    <div class="<?php echo $args["wrapperClass"] . " "; ?><?php echo $args["class"] ? $args["class"] . " " : ''; ?>drawer-menu <?php echo $args["width"]; ?> h-screen top-0 right-0 bottom-0 fixed z-999 flex flex-col p-0 md:p-20<?php echo is_user_logged_in() ? ' pt-46 md:pt-52' : ''; ?>" data-trigger="<?php echo esc_attr($args["buttonClass"]); ?>">
