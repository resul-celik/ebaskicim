...
?>
        ...
        <div class="<?php echo $args["customClass"] . " "; ?>drawer-menu <?php echo $args["width"]; ?> h-screen top-0 right-0 bottom-0 fixed z-999 flex flex-col p-0 md:p-20<?php echo is_user_logged_in() ? ' pt-66 md:pt-52' : ''; ?>">
