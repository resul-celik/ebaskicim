    ...
    <div class="w-full flex flex-row items-center justify-center py-15 border-b border-gray-200">
        <div class="w-full max-w-[1920px] flex flex-row items-center justify-between px-20">
            ...
            <div class="flex flex-row gap-7">
                ...
                <?php else : ?>
                    <a href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>" class="header-button"><span class="header-button-text">Giriş yap / Kaydol</span><i class="icon icon-person"></i></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
